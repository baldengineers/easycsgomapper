...
def createTile(posx, posy, id_num, world_id_num, entity_num, placeholder_list, rotation, level):
    ...
    f = open('tf2/prefab_template/nuke.txt', 'r+')
...
#INSERT_ROT_3_PY_LIST
    ...
    g = open('tf2/prefab_template/nuke_entities.txt', 'r+')
...
#INSERT_ROT_0_PY_LIST
        ...
        pz1 = level*448+ 64
        px2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (218), posy*-1*512 + (-205)), 270)[0])
        py2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (218), posy*-1*512 + (-205)), 270)[1])
        pz2 = level*448+ 73
#INSERT_ROT_1_PY_LIST
        ...
        pz1 = level*448+ 64
        px2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (218), posy*-1*512 + (-205)), 180)[0])
        py2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (218), posy*-1*512 + (-205)), 180)[1])
        pz2 = level*448+ 73
#INSERT_ROT_2_PY_LIST
        ...
        pz1 = level*448+ 64
        px2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (218), posy*-1*512 + (-205)), 90)[0])
        py2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (218), posy*-1*512 + (-205)), 90)[1])
        pz2 = level*448+ 73
#INSERT_ROT_3_PY_LIST
    ent_var_count = 2
    ...
    for i in range(int(valcount.count('nuketemplate'))):
        if "nuketemplate" in ent_values:
            ent_values = ent_values.replace("nuketemplate", "N00kTemplate"+str(entity_num),3)
            ent_values = ent_values.replace("nuke", "nuke"+str(entity_num),3)
            entity_num += 1
