...
def createTile(posx, posy, id_num, world_id_num, entity_num, placeholder_list, rotation, level):
    ...
    f = open('tf2/prefab_template/wall_stone.txt', 'r+')
...
#INSERT_ROT_3_PY_LIST
    ...
    g = open('tf2/prefab_template/wall_stone_entities.txt', 'r+')
...
#INSERT_ROT_0_PY_LIST
        ...
        px1 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-64)), 270)[0])
        py1 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-64)), 270)[1])
        pz1 = level*448 + 64
        px2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-169)), 270)[0])
        py2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-169)), 270)[1])
        pz2 = level*448 + 64
        px3 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512), 270)[0])
        py3 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512), 270)[1])
        pz3 = level*448 + 64
        px4 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-448)), 270)[0])
        py4 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-448)), 270)[1])
        pz4 = level*448 + 64
        px5 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512 + (-512)), 270)[0])
        py5 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512 + (-512)), 270)[1])
        pz5 = level*448 + 64
        px6 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-448)), 270)[0])
        py6 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-448)), 270)[1])
        pz6 = level*448 + 64
        px7 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (400), posy*-1*512 + (-400)), 270)[0])
        py7 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (400), posy*-1*512 + (-400)), 270)[1])
        pz7 = level*448 + 64
#INSERT_ROT_1_PY_LIST

    elif rotation == 2:
        px1 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-64)), 180)[0])
        py1 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-64)), 180)[1])
        pz1 = level*448 + 64
        px2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-169)), 180)[0])
        py2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-169)), 180)[1])
        pz2 = level*448 + 64
        px3 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512), 180)[0])
        py3 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512), 180)[1])
        pz3 = level*448 + 64
        px4 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-448)), 180)[0])
        py4 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-448)), 180)[1])
        pz4 = level*448 + 64
        px5 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512 + (-512)), 180)[0])
        py5 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512 + (-512)), 180)[1])
        pz5 = level*448 + 64
        px6 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-448)), 180)[0])
        py6 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-448)), 180)[1])
        pz6 = level*448 + 64
        px7 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (400), posy*-1*512 + (-400)), 180)[0])
        py7 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (400), posy*-1*512 + (-400)), 180)[1])
        pz7 = level*448 + 64
#INSERT_ROT_2_PY_LIST

    elif rotation == 3:
        px1 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-64)), 90)[0])
        py1 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-64)), 90)[1])
        pz1 = level*448 + 64
        px2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-169)), 90)[0])
        py2 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-169)), 90)[1])
        pz2 = level*448 + 64
        px3 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512), 90)[0])
        py3 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512), 90)[1])
        pz3 = level*448 + 64
        px4 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-448)), 90)[0])
        py4 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (384), posy*-1*512 + (-448)), 90)[1])
        pz4 = level*448 + 64
        px5 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512 + (-512)), 90)[0])
        py5 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (448), posy*-1*512 + (-512)), 90)[1])
        pz5 = level*448 + 64
        px6 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-448)), 90)[0])
        py6 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (416), posy*-1*512 + (-448)), 90)[1])
        pz6 = level*448 + 64
        px7 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (400), posy*-1*512 + (-400)), 90)[0])
        py7 = int(rotatePoint((posx*512+256,posy*-1*512-256), (posx*1*512 + (400), posy*-1*512 + (-400)), 90)[1])
        pz7 = level*448 + 64
#INSERT_ROT_3_PY_LIST
    ent_var_count = 7
